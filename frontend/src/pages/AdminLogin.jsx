...
export default function AdminLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // POST /api/admin/login returns no admin payload — the username
      // just submitted is accurate, so pass it through immediately
      // rather than waiting on a fresh verify() round-trip.
    ...
    <div className="admin-login-wrap">
      <div className="admin-login-card">
        <div className="admin-login-card__header">
          ...
          <p className="admin-login-card__sub">Sign in to manage your portfolio</p>
        </div>
        ...
        <form className="admin-form" onSubmit={handleLogin} noValidate>
          ...
          <button type="submit" className="btn btn--primary btn--block" style={{ padding: "13px 20px", fontSize: 14 }} disabled={loading}>
